...
const CONEXION_API_BASE_URL = "http://localhost:8080/conexionesmysql"
const CONEXION_API_MYSQL = "http://localhost:8080/metadatamysql"
const CONEXION_API_GENERATOR = "http://localhost:8080/metadataGenmysql"
const CONEXION_API_RELACIONES = "http://localhost:8080/relacionesmysql"


class ConexionServiceMysql {
    ...
    getMetadata(url,es,usuario,contraseña){
        return axios.get(CONEXION_API_MYSQL + "/" + url + "/" + es + "/" +usuario + "/" + contraseña);
    }
...
export default new ConexionServiceMysql();