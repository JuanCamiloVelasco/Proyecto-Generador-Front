...
const AddConexion = () => {
    ...
    const saveConexion = (e) => {
        e.preventDefault();
        ConexionServicePost.saveConexion(conexion)
        .then((response) => {
    ...
    <div className='flex max-w-2xl mx-auto shadow border-b'>
        <div className='px-8 py-8 bg-orange-50 background-color: oldlace;'>
            <div className='font-medium text-2xl tracking-wider text-gray-500'>
                <h1>Añadir Nueva Conexion Postgresql</h1>
            </div>
            ...
            <div className='items-center justify-center h-14 w-full my-4'>
                <div className='input-field ' >
                    ...
                    <input type='text' name="es" value={conexion.es} onChange={(e) => handleChange(e)} className='h-10 w-96 border mt-2 px-2 py2'></input>
                </div>
            </div>
            <div className='items-center justify-center h-14 w-full my-4'>
                <div className='input-field ' >
